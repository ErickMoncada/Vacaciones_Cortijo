...
public class Empleados extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        dtpIngreso.setMinSelectableDate(new java.util.Date(631177270000L));
        ...
        dtpNacimiento.setMinSelectableDate(new java.util.Date(-315590330000L));
  ...
  LimpiarErrores();
    ...
    private void txtCodigoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCodigoKeyTyped
        val.EntradaNumeros(txtCodigo, evt, 7);
    ...
    private void txtIdentidadKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtIdentidadKeyTyped
        ...
        val.EntradaNumeros(txtIdentidad, evt, 13);
