...
public class Puestos extends javax.swing.JFrame {
    ...
    private void CargarTabla() {
        ...
        CrearTabla.CargarTabla(tblCentro, "SELECT puesto from [VistaPuesto]");
    }
    ...
    private void initComponents() {
        ...
        lblCategoriaUser.setText("Puesto de Trabajo:");
    ...
    private void tblCentroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCentroMouseClicked
        ...
        if (classcrud.CargarDatoClick(tblCentro, "SELECT [IdPuesto],[puesto] from VistaPuesto where puesto=?", "Puesto", "IdPuesto", txtPuesto, txtID)) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        AccionesCrud classcrud = new AccionesCrud();
        if (classcrud.Validar(txtPuesto, "El Puesto de Trabajo")) {
            Object[] datos = new Object[1];
            datos[0] = txtPuesto.getText().trim();
            if (classcrud.Guardar_Modificar(datos, "exec AgregarPuestoTrabajo ? ")) {
                txtID.setText("");
                txtPuesto.setText("");
                CargarTabla();
            }
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        AccionesCrud classcrud = new AccionesCrud();
        if (classcrud.Validar(txtPuesto, "El Puesto de Trabajo")) {
            if (classcrud.Modificar(txtPuesto, txtID, "exec UpdatePuestoTrabajo ?,?")) {
                CargarTabla();
                Limpiar();
            }
        }
    ...
    private void btnEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEliminarActionPerformed
        ...
        AccionesCrud classcrud = new AccionesCrud();
        if (classcrud.Validar(txtPuesto, "La Categoría de usuario")) {
            if (classcrud.Eliminar(txtID, "exec EliminarPuestoTrabajo ?")) {
                CargarTabla();
                Limpiar();
            }
        }
    ...
    private void txtPuestoKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtPuestoKeyTyped
        ...
        val.EntradaSoloLetas(txtPuesto, evt, 60);
