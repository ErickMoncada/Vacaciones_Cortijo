...
public class Puestos extends javax.swing.JFrame {
    ...
    private void tblCentroMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tblCentroMouseClicked
        ...
        if (classcrud.CargarDatoClick(tblCentro, "SELECT [IdPuesto],[puesto] from VistaPuesto where puesto=?", "Puesto", "IdPuesto", txtCategoriaUser, txtID)) {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        AccionesCrud classcrud = new AccionesCrud();
        if (classcrud.Validar(txtCategoriaUser, "El Puesto de Trabajo")) {
    ...
    private void btnModificarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnModificarActionPerformed
        ...
        AccionesCrud classcrud = new AccionesCrud();
        if (classcrud.Validar(txtCategoriaUser, "El Puesto de Trabajo")) {
            if (classcrud.Modificar(txtCategoriaUser, txtID, "exec UpdatePuestoTrabajo ?,?")) {
                CargarTabla();
                Limpiar();
            }
        }
